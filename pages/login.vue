            ...
            <v-card class="elevation-1 pa-3">
              <v-card-text>
                <div class="layout column align-center">
                  <img src="../static/img.png" alt="Vue Material Admin" width="120" height="120">
                  <h3 class="flex my-4 primary--text">Seesay Admin dashboard</h3>
                </div>
                <v-form>
                  <v-text-field append-icon="person" name="login" label="Login" type="email"
